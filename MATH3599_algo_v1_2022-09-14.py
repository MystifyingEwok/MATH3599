...
data = pd.read_csv (r'C:\Users\lenno\OneDrive\Desktop\S2 2022\MATH3599\Resources\IndexFutures\IndexFutures\ContractFutures_1min_uic4039.csv')   
...
# reverse the list - 
hist_qoutes = hist_qoutes[::-1].reset_index(drop = True)
